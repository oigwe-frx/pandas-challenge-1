...
# Add a column that calculates the  subtotal for each line using the unit_price and the qty
df['line_subtotal'] = df['unit_price'] * df['qty']
df.head()

# Add a column for shipping price for each order
 # Assumptions:
...
# Add a column for the total price for each order
 # Assumptions:
 # - a sales tax of 9.25%
...
# Add a column for the cost of each line using unit cost, qty, and shipping price
  # Assumptions:
...
# Format the data: Currency should be in millions of dollars.
